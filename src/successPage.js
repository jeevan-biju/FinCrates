...
const success_logo =
  "https://firebasestorage.googleapis.com/v0/b/xsnipp-prot-2.appspot.com/o/success%20trans.png?alt=media&token=acec47f6-0caf-46ce-b0ad-81383bd79f2c";
  ...
  return (
    <div className="App">
      ...
      <div className="wholeblock">
        <img className="successimg" src={success_logo}></img>
        <h3 className="upload_txt">UPLOAD COMPLETE</h3>
        <p className="cong_txt">
          Congrats! Subscription Has Been Successfully Added
        </p>
